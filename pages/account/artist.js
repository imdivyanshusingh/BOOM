...
function Artist() {
  ...
  return (
    <main className="flex flex-col items-center w-screen h-screen max-w-screen max-h-screen text-white bg-dark">
      <Head>
        <title>BOOM-NEAR | Create An Artist</title>
        <meta
          name="description"
      ...
      <h1 className="p-8 text-3xl font-bold font-mono">BOOM-NEAR / minting</h1>
      <div className="flex flex-col items-center justify-center h-full w-full gap-2 text-center">
        {content()}
      </div>
      <p className="p-2 font-xs text-gray-500">EncodeXNear 2023</p>
    </main>
  );
}
